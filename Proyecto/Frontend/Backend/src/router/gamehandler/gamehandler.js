...
gamehandler.post('/',async(req,res)=>{
    ...
    try{
        const {id,name,Genres,description,release,image,devices,ratings} = req.body
        const newgame = await creategame({id,name,Genres,description,release,image,devices,ratings})
